...
struct RedfishPropertyParent* createChassisResource()
{
    ...
    static struct RedfishLinkJson computerSystemsLink;
    static struct RedfishLinkJson containedBy;
    ...
    bejAddLinkToJson(&computerSystemsArray, &computerSystemsLink, "",
                     "/redfish/v1/Systems/system");

    bejAddLinkToJson(&links, &containedBy, "ContainedBy",
                     "/redfish/v1/Chassis/SomeOtherChassis");

    bejCreateArrayOfLinksJson(&links, "Contains", containsLinkCount, contains,
                              &containsArray, containsLinks);

    bejCreateArrayOfLinksJson(&links, "Storage", /*linkCount=*/1, storage,
                              &storageArray, &storageLink);

    bejCreateArrayOfLinksJson(&links, "Drives", /*linkCount=*/1, drives,
